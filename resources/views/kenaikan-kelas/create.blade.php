    ...
    <div class="card-body">
        <form action="{{ route('kenaikan-kelas.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kelas_lama" id="kelas_lama" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="kelas_baru">Kelas Baru</label>
                <input type="text" name="kelas_baru" id="kelas_baru" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <a href="{{ route('kenaikan-kelas.index') }}" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</div>
@endsection