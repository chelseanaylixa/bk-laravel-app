...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="container mx-auto p-4 md:p-8">
        <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-6xl mx-auto text-center">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between mb-12">
                <div class="text-left md:w-1/2 md:pr-8">
                    ...
                    <button id="btn-konsultasi" class="mt-6 bg-emerald-500 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-emerald-600 transition-colors">
                        Konsultasi Sekarang
                    </button>
                </div>
                <div class="mt-8 md:mt-0 md:w-1/2 flex justify-center">
                    <!-- Mengganti gambar dengan teks -->
            ...
            <!-- Bagian Layanan Kami -->
            <div class="mb-12">
                <span class="inline-block px-4 py-1 rounded-full text-sm font-semibold text-emerald-700 bg-emerald-200 mb-4">Layanan Kami</span>
            ...
            <!-- Bagian Apa yang Sedang Kamu Rasakan? -->
            <div>
